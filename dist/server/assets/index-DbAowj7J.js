...
import { N as Navbar, F as Footer } from "./Footer-DJ5VQjwp.js";
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1280px] mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsxs("div", { className: "relative max-w-5xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "relative font-serif text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-brown-deep max-w-5xl mx-auto leading-[1.02] tracking-[-0.01em] text-balance", children: "WE HAVE PROFESSIONAL CATERING TEAMS AT LOGO" })
        ] }) }),
